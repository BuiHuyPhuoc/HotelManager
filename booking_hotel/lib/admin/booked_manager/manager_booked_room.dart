...
class ManagerBookedRoom extends StatefulWidget {
  const ManagerBookedRoom({super.key});

  @override
  State<ManagerBookedRoom> createState() => _ManagerBookedRoomState();
}

class _ManagerBookedRoomState extends State<ManagerBookedRoom> {
  late Future<List<Booking>> _bookingRoom;

  void GetData() async {
    _bookingRoom = getAllBookingRoom();
    setState(() {});
  }
